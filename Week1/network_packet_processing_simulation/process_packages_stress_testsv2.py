...
class Buffer:
	...
	def Process(self, request):
		...
		if len(buffer1.finish_time) == self.size:	
        	...
        	#if buffer1.finish_time.pop() - previous_process_time >= request.arrival_time:	
			...
			return Response(True, -1)
				...
				return Response(False, request.arrival_time + request.process_time + previous_finish_time)
